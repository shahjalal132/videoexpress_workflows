...
| [`WORKFLOW.json`](WORKFLOW.json) | Machine‑readable config (v2.8.3): pre-authorized duplicate cleanup, verified audio transfer, structural-only storyboard acceptance, prompt-book preparation, current VideoExpress flow, checkpoints, recovery, and safety rules. |
...
| [`WORKFLOW_STATE.example.json`](WORKFLOW_STATE.example.json) | Compact v2.8.3 checkpoint example showing pre-authorized cleanup, verified audio transfer, structural storyboard acceptance, prompt-book preparation, latest-flow submission, and separate generation monitoring. |
| `README.md` | This file. |
