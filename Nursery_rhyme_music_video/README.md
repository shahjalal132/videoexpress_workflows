...
| [`WORKFLOW.json`](WORKFLOW.json) | Machine‑readable config (v2.9.0): strict mouth-locked prompt architecture, pre-authorized duplicate cleanup, verified audio transfer, structural-only storyboard acceptance, current VideoExpress flow, checkpoints, recovery, and safety rules. |
